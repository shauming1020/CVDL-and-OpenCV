...
BEGIN_MESSAGE_MAP(COpenCV_HW1App, CWinApp)
...
// 僅有的一個 COpenCV_HW1App 物件

COpenCV_HW1App theApp;


// COpenCV_HW1App 初始設定

BOOL COpenCV_HW1App::InitInstance()
{
